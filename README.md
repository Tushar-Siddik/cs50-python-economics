...
1. **Lecture 0: Functions, Variables, and More**
...
1. Clone or download this repository:
   ```bash
   git clone https://github.com/Tushar-Siddik/cs50-python-economics.git
   cd cs50-python-economics
   ```
...
5. Navigate to the notebooks directory and start learning!
...
1. **Sequential Learning**: Start with Lecture 0 and progress through each lecture in order
2. **Active Participation**: Run the code cells, modify them, and experiment with different values
3. **Practice Problems**: Complete the practice problems at the end of each notebook
4. **Economic Applications**: Pay special attention to the economic examples and try to relate them to your field of study

## Course Structure

Each lecture notebook follows this structure:

1. **Introduction**: Overview of the programming concepts and their economic applications
2. **Concept Explanation**: Detailed explanation of programming concepts
3. **Simple Examples**: Basic examples to understand the concept
4. **Economic Examples**: Real-world economic applications
5. **Practice Problems**: Problems to test your understanding
6. **Solutions**: Detailed solutions to the practice problems
...
3. Make your changes (additional examples, corrections, etc.)
...
This project maintains the educational spirit of CS50 while providing enhanced materials. The original CS50 course materials are licensed under [Attribution-NonCommercial-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-nc-sa/4.0/) CC BY-NC-SA 4.0, and this enhanced version follows the same licensing approach.
